...
def buy():
    ...
    if request.method == "POST":
        ...
        quote = lookup(request.form.get("price"))

        # returns the values to the web page
        return render_template("index.html", name = quote['name'], symbol = quote['symbol'], price = quote
        ['price'])
...
def quote():
    ...
    if request.method == "POST":
        ...
        # returns the values to the web page
        return render_template("quoted.html", name = quote['name'], symbol = quote['symbol'], price = quote
        ['price'])
